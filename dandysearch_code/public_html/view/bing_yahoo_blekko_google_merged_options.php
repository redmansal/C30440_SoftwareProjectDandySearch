    ...
    <div class="stretch_white">
     ...
     <div class="surround_select_search_type">
      ...
      <form name="input" action="index.php" method="get">
        ...
        <input type="hidden" id="admin" name="source_page" value="bing_yahoo_blekko_google_merged_options" />
          ...
          <input type="checkbox" name="remove_puncuation_on" value="yes" /> Turn on Punctuation on the query<br /> 
